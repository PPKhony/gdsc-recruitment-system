        ...
        <Col lg={5} xl={4} className="mb-3 p-0 p-lg-3">
          <Card>
            ...
            <CardBody>
              ...
              <h4>
                ปลดปล่อยไอเดียสุดครีเอท! สร้างสรรค์ผลงานให้ GDSC TU
                โดดเด่นกว่าใคร! ✨
              </h4>

              <p>
                <strong>นี่คือที่ของคนรุ่นใหม่ไฟแรง!</strong> 🔥
                ที่พร้อมจะใช้พลังแห่งความคิดสร้างสรรค์ สะกดทุกสายตา ให้ GDSC TU
                เป็นที่รู้จักในวงกว้าง!{" "}
              </p>

              <p>
                <strong>Creative Team GDSC TU</strong> กำลังมองหา{" "}
                <strong>ครีเอทีฟสายเลือดใหม่</strong>{" "}
                มาร่วมทีมปลุกพลังไอเดียสุดเจ๋ง ออกแบบ Design Content สุดปัง
                ในช่องทางต่างๆของ GDSC TU ให้โดดเด่น เข้าถึง Connect
                กับทุกคน!{" "}
              </p>

              <h5>สิ่งที่คุณจะได้:</h5>
              <ul>
                <li>
                  <strong>ปลดปล่อยไอเดียสร้างสรรค์:</strong> ออกแบบสื่อ Content
                  และแคมเปญการตลาด ให้ GDSC TU โดดเด่นและน่าสนใจ
                </li>
                <li>
                  <strong>ทำงานร่วมกับทีมสุดเจ๋ง:</strong> แลกเปลี่ยนเรียนรู้
                  และเติบโตไปกับทีม Creative และทีม GDSC TU{" "}
                </li>
                <li>
                  <strong>พัฒนาทักษะ และประสบการณ์จริง:</strong>{" "}
                  ใช้ความคิดสร้างสรรค์ และทักษะ Design เพื่อสร้างผลงานจริง
                  ที่เห็นผลลัพธ์ได้จริง
                </li>
                <li>
                  <strong>สนุกไปกับการทำงานที่ท้าทาย:</strong>{" "}
                  ร่วมเป็นส่วนหนึ่งของทีม GDSC TU
                  และสร้างสรรค์ผลงานที่น่าภาคภูมิใจ{" "}
                </li>
              </ul>
